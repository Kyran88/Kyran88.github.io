  ...
  Chat = (function() {
    function e(t) {
      ...
      return (
        ...
        (this.state = { hasSeenMaxCharResponse: !1 }),
        (this.callbacks = {}),
        (this.messages = t),
        ...
        this.hostElement ||
          console.warn("Host element coulndt be attached. Node not found"),
        ...
        this.say(this.messages.greeting),
        this
      );
    }
    return (
      _createClass(e, [
          ...
          value: function(e, t, n) {
            ...
            (e.style.transform = "translate3d(" + r + "px, " + c + "px, 0)"),
              ...
              i.forEach(function(t) {
                if (t !== e)
                  return (t.style.transform = "translate3d(0, 100px, 0)");
              });
          }
        },
        {
        ...
        },
        {
          ...
          value: function(e, t) {
            var n = this,
              s = Object.assign({}, { delay: 0, onFinish: function() {} }, t),
              i = this.createSpeechBubble({
                text: e.text || "",
                type: "response"
              });
            return (
              (i.style.transform = "translate3d(0, 72px, 0)"),
              this.answers.appendChild(i),
              setTimeout(function() {
                (i.style.transform = "translate3d(0, 0, 0)"),
                  i.addEventListener(
                    "transitionend",
                    setTimeout(s.onFinish.bind(n, i), 750)
                  );
              }, 450 + s.delay),
              i
            );
          ...
          value: function(e) {
            var t = this,
              n = e.answers.map(function(e, n) {
                return t.createAnswerButton(e, { delay: 65 + 65 * n });
              });
            n.forEach(function(n, s) {
              n.addEventListener("click", function(i) {
                t.animateResponse(n, n.cloneNode(!0), function() {
                  t.say(t.messages[e.answers[s].path]),
                    t.emit("answer", { item: e.answers[s] });
                });
              });
            });
          }
            ...
            n.classList.add("cui__answers__placeholder"),
              ...
              n.addEventListener("keyup", function(e) {
                return n.innerText.length
                  ? void n.classList.remove("cui__answers__placeholder")
                  : (n.classList.add("cui__answers__placeholder"), n.focus());
              });
            var s = !1,
              i = function() {
                n.innerText.length &&
                  ...
                  t.animateResponse(n, n.cloneNode(!0), function(n) {
                    e.path && t.say(t.messages[e.path]),
                      t.emit("answer", { item: e, text: n.innerHTML });
                  }));
              };
            n.addEventListener("blur", i.bind(this)),
              n.addEventListener("keydown", function(e) {
                13 === e.keyCode &&
                  (e.preventDefault(), n.removeEventListener("blur", i), i());
              }),
              n.addEventListener("keypress", function(e) {
                n.innerText.length > t.config.maxCharsResponse &&
                  (e.preventDefault(),
                  t.state.hasSeenMaxCharResponse ||
                    ((t.state.hasSeenMaxCharResponse = !0),
                    t.say([t.config.maxCharsResponseText])));
              });
          }
        },
        {
          ...
          value: function(e) {
            ...
            e.forEach(function(e, n) {
              setTimeout(function() {
                ...
                var n = t.createSpeechBubble({ text: e });
                t.addSpeechBubble(n);
