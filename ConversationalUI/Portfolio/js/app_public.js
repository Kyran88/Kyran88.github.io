     ...
     function(e, t) {
         ...
         var e = function(e) {
             return {
                 ...
                 "companies-realwork": ["Hah! Good one.", "Writing and speaking is part of my job. It gives me a broader perspective and helps me solve problems.ðŸ‘€ðŸ™‡", "Speaking of writing, you can drop me a line and I'll get back to you. Otherwise, I'll let you browse my website for a little.", {
                     type: "choose",
                     answers: [{
                         text: "Let's talk!",
                         path: "contact"
                 ...
                 "contact-verify-email": ["That's one beautiful email address! I'll get back to you as soon as possible.", 'Meanwhile, you can check my website or go to <a href="http://www.google.com">Google.com</a> and try pressing the "I feel lucky" button. It might be your lucky day!', "Talk to you soon! Get ready to be scrolled! ðŸƒðŸ’¨"],
                 "contact-verify-email-failed": ["Your email reminds me of the poop emoji. Something doesn't feel quite right here... ðŸ’©", "Shall we try again? ;)", {
                     type: "choose",
                     answers: [{
                         text: "Yes, here it is...!",
                 ...
                 "uidesigner-no": ["Interesting... I really appreciate your interest in design though.", "By the way, you should check out my friend Siri too! She's hilarious. I think you guys would get along! ðŸ‘­", "Alright, gotta run to a meeting now. I'll let you browse my website now."],
                 "uidesigner-yes": ["Hah! I thought so!", "You are now part of the secret UX guild! We discuss design links every day, whenever you come here.", "Let's talk about design shall we? ðŸ¤—", {
                     type: "choose",
                     answers: [{
                 ...
                 read: ["All right! Let's talk UX then! ðŸ™Œ"]
             }
         };
         return e
         ...
         function n() {
             ...
             var s = ["Hey! It's good to have you back!", "There you are again! ðŸ™Œ", "Hey what's up?", "Hey, welcome back!", "Welcome back. ðŸ¤—", "Ciao!", "GrÃ¼etzi! ðŸ‡¨ðŸ‡­", "Bonjour mon ami!", "Hey! How are you doing? It's good to have you back."],
