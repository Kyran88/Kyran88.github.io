! function(t) {
    ...
    t("#tooltip-hover").tooltipster(), t("#tooltip-events").tooltipster({
        ...
        content: t('<img src="assets/images/users/avatar-2.jpg" width="50" height="50" /><p style="text-align:left;"><strong>SoufflÃƒÂ© chocolate cake powder.</strong> Applicake lollipop oat cake gingerbread.</p>'),
        minWidth: 300,
        maxWidth: 300,
        position: "right"
