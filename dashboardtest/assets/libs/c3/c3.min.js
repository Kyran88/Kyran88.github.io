/* @license C3.js v0.6.14 | (c) C3 Team and other contributors | http://c3js.org/ */ ! function(t, e) {
    ...
    i.prototype.axisX = function(t, e, i) {
        ...
        return T.scale = function(t) {
            ...
            var t;
            return (t = b.isCategory ? 2 * w.tickOffset : (T.g.select("path.domain").node().getTotalLength() - 2 * w.outerTickSize) / T.g.selectAll("line").size()) === 1 / 0 ? 0 : t
        }, T.ticks = function() {
    ...
    return l.prototype.beforeInit = function() {}, l.prototype.afterInit = function() {}, l.prototype.init = function() {
        ...
        var i, n, r, a, o, s, c, d, l, u, h, g, p, f, _, x, y, m, S, w, v, b, T, A, P, C, L, V, G, E, I, O = this,
            R = O.main,
            k = O.d3,
            D = O.config,
        ...
        }), T = O.generateWait(), b.forEach(function(t) {
            T.add(t)
        }), T(function() {
            A && A(), D.onrendered && D.onrendered.call(O)
        })) : (O.redrawBar(_), O.redrawLine(x), O.redrawArea(f), O.redrawCircle(E, I), O.redrawText(y, m, t.flow), O.redrawRegion(), O.redrawGrid(), A && A(), D.onrendered && D.onrendered.call(O))), O.mapToIds(O.data.targets).forEach(function(t) {
            O.withoutFadeIn[t] = !0
        })
        ...
        return m = P(x) ? x : P(y) ? m < y ? m : y - 10 : m, S = P(y) ? y : P(x) ? x < S ? S : x + 10 : S, 0 === _.length ? "y2" === e ? g.y2.domain() : g.y.domain() : (isNaN(m) && (m = 0), isNaN(S) && (S = m), m === S && (m < 0 ? S = 0 : m = 0), u = 0 <= m && 0 <= S, h = m <= 0 && S <= 0, (P(x) && u || P(y) && h) && (v = !1), v && (u && (m = 0), h && (S = 0)), a = o = .1 * (r = Math.abs(S - m)), void 0 !== w && (S = w + (s = Math.max(Math.abs(m), Math.abs(S))), m = w - s), T ? (c = g.getDataLabelLength(m, S, "width"), d = R(g.y.range()), a += r * ((l = [c[0] / d, c[1] / d])[1] / (1 - l[0] - l[1])), o += r * (l[0] / (1 - l[0] - l[1]))) : A && (c = g.getDataLabelLength(m, S, "height"), a += g.axis.convertPixelsToAxisPadding(c[1], r), o += g.axis.convertPixelsToAxisPadding(c[0], r)), "y" === e && C(p.axis_y_padding) && (a = g.axis.getPadding(p.axis_y_padding, "top", a, r), o = g.axis.getPadding(p.axis_y_padding, "bottom", o, r)), "y2" === e && C(p.axis_y2_padding) && (a = g.axis.getPadding(p.axis_y2_padding, "top", a, r), o = g.axis.getPadding(p.axis_y2_padding, "bottom", o, r)), v && (u && (o = m), h && (a = -S)), n = [m - o, S + a], b ? n.reverse() : n)
        ...
        function R(t, e, i) {
            ...
            function p(t, e) {
                e || (n = (g - C - h) / 2) < A && (n = (g - h) / 2, C = 0, O++), I[t] = O, E[O] = m.isLegendInset ? 10 : n, L[t] = C, C += h
            }
            s && (T = b = O = C = 0), !S.legend_show || m.isLegendToShow(e) ? (V[e] = l, G[e] = u, (!b || b <= l) && (b = l), (!T || T <= u) && (T = u), r = m.isLegendRight || m.isLegendInset ? T : b, S.legend_equally ? (Object.keys(V).forEach(function(t) {
                V[t] = b
            }), Object.keys(G).forEach(function(t) {
                G[t] = T
            }), (n = (g - r * f.length) / 2) < A ? (O = C = 0, f.forEach(function(t) {
                p(t)
        ...
        }), m.updateLegendItemWidth(b), m.updateLegendItemHeight(T), m.updateLegendStep(O), m.updateSizes(), m.updateScales(), m.updateSvgSize(), m.transformAll(g, e), m.legendHasRendered = !0
        ...
        for (f && t.sort(f), a = 0; a < t.length; a++)
            if (t[a] && (t[a].value || 0 === t[a].value) && (r || (o = _(h ? h(t[a].x, t[a].index) : t[a].x), r = "<table class='" + l.CLASS.tooltip + "'>" + (o || 0 === o ? "<tr><th colspan='2'>" + o + "</th></tr>" : "")), void 0 !== (s = _(p(t[a].value, t[a].ratio, t[a].id, t[a].index, t))))) {
