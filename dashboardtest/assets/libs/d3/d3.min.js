...
! function(t, n) {
    ...
    function ye(t, n) {
        var e, r, i, o = ve.lastIndex = ge.lastIndex = 0,
            ...
            c = [];
        for (t += "", n += "";
            (e = ve.exec(t)) && (r = ge.exec(n));)(i = r.index) > o && (i = n.slice(o, i), u[a] ? u[a] += i : u[++a] = i), (e = e[0]) === (r = r[0]) ? u[a] ? u[a] += r : u[++a] = r : (u[++a] = null, c.push({
            i: a,
            x: de(e, r)
        })), o = ge.lastIndex;
    ...
    var me, xe, we, Me, Ne = 180 / Math.PI,
        Ae = {
            translateX: 0,
            translateY: 0,
            rotate: 0,
    ...
    var Xe, Ge, Ve = 0,
        ...
        nr = "object" == typeof window && window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : function(t) {
            setTimeout(t, 17)
        };
    ...
    Cr.prototype = Pr.prototype = {
        ...
        select: function(t) {
            ...
            for (var r = this._groups, i = r.length, o = new Array(i), a = 0; a < i; ++a)
                for (var u, c, f = r[a], s = f.length, l = o[a] = new Array(s), h = 0; h < s; ++h)(u = f[h]) && (c = t.call(u, u.__data__, h, f)) && ("__data__" in u && (c.__data__ = u.__data__), l[h] = c, mr(l[h], n, e, h, l, Mr(u, e)));
    ...
    Pt.prototype.interrupt = function(t) {
        ...
        for (var r = this._groups, i = r.length, o = 0; o < i; ++o)
            for (var a, u = r[o], c = u.length, f = 0; f < c; ++f)(a = u[f]) && mr(a, t, n, f, u, e || fi(a, n));
    ...
    function zi(n) {
        ...
        function l() {
            ...
            function B() {
                ...
                l < o && (w *= -1, t = r, r = s, s = t, t = o, o = l, l = t, m in Mi && L.attr("cursor", wi[m = Mi[m]])), d < u && (M *= -1, t = a, a = h, h = t, t = u, u = d, d = t, m in Ni && L.attr("cursor", wi[m = Ni[m]])), N.selection && (T = N.selection), y && (o = T[0][0], l = T[1][0]), _ && (u = T[0][1], d = T[1][1]), T[0][0] === o && T[0][1] === u && T[1][0] === l && T[1][1] === d || (N.selection = [
                    [o, u],
                    [l, d]
                ], c.call(b), D.brush())
            }
        ...
        return u.move = function(t, e) {
            ...
            return arguments.length ? (r = "function" == typeof t ? t : li([
                [+t[0][0], +t[0][1]],
                [+t[1][0], +t[1][1]]
            ]), u) : r
        }, u.filter = function(t) {
    ...
    function Co(t) {
        ...
        function r(t, n) {
            ...
            for (t.charCodeAt(o - 1) === No && --o, t.charCodeAt(o - 1) === Ao && --o;
                (r = s()) !== wo;) {
    ...
    sa.copy = function() {
        var t, n, e = new ca(this._x, this._y, this._x0, this._y0, this._x1, this._y1),
            r = this._root;
        if (!r) return e;
        ...
        var r, i, o, a, u, c, f, s = this._x0,
            ...
            p = [],
            v = this._root;
        for (v && p.push(new ia(v, s, l, h, d)), null == e ? e = 1 / 0 : (s = t - e, l = n - e, h = t + e, d = n + e, e *= e); c = p.pop();)
    ...
    var ka, Ea = ["y", "z", "a", "f", "p", "n", "Âµ", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"];
            ...
            function m(t) {
                ...
                if ("c" === v) x = _(t) + x, t = "";
                    ...
                    if (t = _(Math.abs(t), d), p && (t = function(t) {
                        ...
                        }(t)), w && 0 == +t && (w = !1), m = (w ? "(" === c ? c : "-" : "-" === c || "(" === c ? "" : c) + m, x = ("s" === v ? Ea[8 + xa / 3] : "") + x + (w && "(" === c ? ")" : ""), b)
    ...
    var Du, qu, Lu, Uu, Ou, Bu, Yu, Fu, Iu, ju, Hu, Xu, Gu, Vu, $u, Wu, Zu, Qu, Ju, Ku, tc, nc, ec, rc, ic, oc, ac = qa(),
        uc = {
            point: cc,
            lineStart: sc,
            lineEnd: lc,
    ...
    var Zc = Vc(function() {
        ...
        var i;
        if (null == t) i = e * Ia, r.point(-Fa, i), r.point(0, i), r.point(Fa, i), r.point(Fa, 0), r.point(Fa, -i), r.point(0, -i), r.point(-Fa, -i), r.point(-Fa, 0), r.point(-Fa, i);
        ...
        return Vc(o, function(t) {
            ...
            return {
                ...
                point: function(l, h) {
                    ...
                    if (!n && (f = c = v) && t.lineStart(), v !== c && (!(d = a(n, p)) || Yc(n, d) || Yc(p, d)) && (p[0] += Ba, p[1] += Ba, v = o(p[0], p[1])), v !== c) s = 0, v ? (t.lineStart(), d = a(p, n), t.point(d[0], d[1])) : (d = a(n, p), t.point(d[0], d[1]), t.lineEnd()), n = d;
                    else if (i && n && r ^ v) {
                        var y;
    ...
    function ff(t, n) {
        ...
        var e = nu(n *= Ga),
            ...
            a = r * nu(i),
            u = rf * e - ef * r * o,
            c = ef * e + rf * r * o; of .add(Wa(ru(a * a + u * u), c)), nf = t, ef = e, rf = r
    }
    ...
    function Ls(t) {
        ...
        return A.stream = function(t) {
                ...
                return arguments.length ? (M = null == t ? (w = r = i = o = null, Af) : tf(w = +t[0][0], r = +t[0][1], i = +t[1][0], o = +t[1][1]), k()) : null == w ? null : [
                    [w, r],
                    [i, o]
                ]
            }, A.scale = function(t) {
    ...
    function dl(t, n) {
        var e, r, i, o, a, u = new yl(t),
            c = +t.value && (u.value = t.value),
            f = [u];
        for (null == n && (n = pl); e = f.pop();)
            if (c && (e.value = +e.data.value), (i = n(e.data)) && (a = i.length))
                for (e.children = new Array(a), o = a - 1; o >= 0; --o) f.push(r = e.children[o] = new yl(i[o])), r.parent = e, r.depth = e.depth + 1;
    ...
    function ml(t, n) {
        ...
        for (e = 0; e < t.length - 1; ++e)
            for (r = e + 1; r < t.length; ++r)
                if (xl(Al(t[e], t[r]), n) && xl(Al(t[e], n), t[r]) && xl(Al(t[r], n), t[e]) && Ml(Tl(t[e], t[r], n), t)) return [t[e], t[r], n];
        throw new Error
    }
    ...
    function Pl(t) {
        ...
        t: for (u = 3; u < i; ++u) {
            ...
            for (r.previous = n, r.next = e, n.next = e.previous = e = r, o = El(n);
                (r = r.next) !== e;)(a = El(r)) < o && (n = r, o = a);
            e = n.next
        }
        for (n = [e._], r = e;
    ...
    function Ah(t, n, e) {
        var r = t[0],
            ...
            o = n[0],
            a = n[1];
        return i < r ? (r = Mh(i, r), o = e(a, o)) : (r = Mh(r, i), o = e(o, a)),
            function(t) {
                return o(r(t))
            }
    }
    ...
    T_.prototype = {
        ...
        lineEnd: function() {
            ...
            if (e)
                if (this._line ? this._context.lineTo(t[0], n[0]) : this._context.moveTo(t[0], n[0]), 2 === e) this._context.lineTo(t[1], n[1]);
                    ...
                    for (var r = q_(t), i = q_(n), o = 0, a = 1; a < e; ++o, ++a) this._context.bezierCurveTo(r[0][o], i[0][o], r[1][o], i[1][o], t[a], n[a]);
        ...
        remove: function(t) {
            ...
            var n, e, r, i = t.U,
                o = t.L,
                a = t.R;
            if (e = o ? a ? Q_(a) : o : a, i ? i.L === t ? i.L = e : i.R = e : this._ = e, o && a ? (r = e.C, e.C = t.C, e.L = o, o.U = e, e !== a ? (i = e.U, e.U = t.U, t = e.R, i.L = t, e.R = a, a.U = e) : (e.U = i, i = e, t = e.R)) : (r = t.C, t = e), t && (t.U = i), !r)
                if (t && t.C) t.C = !1;
                else {
                    do {
                        if (t === this._) break;
    ...
    function Tb(t, n) {
        ...
        for (wb = [], mb = new Array(t.length), bb = new V_, xb = new V_;;)
            if (i = ab, o && (!i || o[1] < i.y || o[1] === i.y && o[0] < i.x)) o[0] === e && o[1] === r || (gb(o), e = o[0], r = o[1]), o = t.pop();
            else {
                if (!i) break;
                vb(i.arc)
            } if (function() {
            ...
            function(t, n, e, r) {
                var i, o, a, u, c, f, s, l, h, d, p, v, g = mb.length,
                    y = !0;
                for (i = 0; i < g; ++i)
                    if (o = mb[i]) {
    ...
    Pb.prototype = Eb.prototype, t.version = "5.9.7", t.bisect = i, t.bisectRight = i, t.bisectLeft = o, t.ascending = n, t.bisector = e, t.cross = function(t, n, e) {
        ...
        function o() {
            for (var t, o, u, c, f, s, l, h = n.length, d = 0; d < i; ++d)
                for (o = ua(n, la, ha).visitAfter(a), t = 0; t < h; ++t) u = n[t], s = e[u.index], l = s * s, c = u.x + u.vx, f = u.y + u.vy, o.visit(p);
        ...
        function s(r) {
            for (var i = 0, a = t.length; i < f; ++i)
                for (var u, c, s, l, h, d, p, v = 0; v < a; ++v) c = (u = t[v]).source, l = (s = u.target).x + s.vx - c.x - c.vx || ea(), h = s.y + s.vy - c.y - c.vy || ea(), l *= d = ((d = Math.sqrt(l * l + h * h)) - e[v]) / d * r * n[v], h *= d, s.vx -= l * (p = o[v]), s.vy -= h * p, c.vx += l * (p = 1 - p), c.vy += h * p
        }
        ...
        return Iu = ju = null, Du === 1 / 0 || qu === 1 / 0 ? [
            [NaN, NaN],
            [NaN, NaN]
        ] : [
            [Du, qu],
        ...
        return s.invert = function(t) {
            ...
            return e = a.translate(t).clipExtent([
                ...
                [o - .425 * n + Ba, s + .12 * n + Ba],
                [o - .214 * n - Ba, s + .234 * n - Ba]
            ]).stream(f), i = c.translate([o - .205 * n, s + .212 * n]).clipExtent([
                [o - .214 * n + Ba, s + .166 * n + Ba],
                [o - .115 * n - Ba, s + .234 * n - Ba]
            ]).stream(f), l()
        ...
        return o = {
            ...
            clipExtent: function(r) {
                return arguments.length ? (d = null == r ? (h = t = n = e = null, Af) : tf(h = +r[0][0], t = +r[0][1], n = +r[1][0], e = +r[1][1]), p()) : null == h ? null : [
                    [h, t],
                    [n, e]
                ]
            },
        ...
        function i(i) {
            var c = function(t) {
                for (var n, e, r, i, o, a = new Ql(t, 0), u = [a]; n = u.pop();)
                    if (r = n._.children)
                        for (n.children = new Array(o = r.length), i = o - 1; i >= 0; --i) u.push(e = n.children[i] = new Ql(r[i], i)), e.parent = n;
        ...
        function c() {
            ...
            if (u || (u = c = Xi()), h < l && (f = h, h = l, l = f), h > fy)
                if (v > hy - fy) u.moveTo(h * iy(d), h * uy(d)), u.arc(0, 0, h, d, p, !g), l > fy && (u.moveTo(l * iy(p), l * uy(p)), u.arc(0, 0, l, p, d, g));
                else {
                    var y, _, b = d,
                        m = p,
                        x = d,
        ...
        if (i)
            for (r in n = null == n ? null : n + "", i)
                if ((e = i[r]).state > pr && e.name === n) return new Cr([
                    [t]
                ], si, n, +r);
        return null
        ...
        return y.transform = function(t, n) {
            ...
            return arguments.length ? (i = "function" == typeof t ? t : Sb([
                [+t[0][0], +t[0][1]],
                [+t[1][0], +t[1][1]]
            ]), y) : i
