{
  ...
  const init = () => {
    let welcomeReplies = [
      'document.write("userTitle"); &#x1F44B; I\'m Kyran, I try to create the best user experiences possible, both physical and virtual, using humour, friendliness, web technologies and good design.'
    ];
